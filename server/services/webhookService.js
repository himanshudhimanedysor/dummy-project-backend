  ...
  try {
    ...
    const promises = webhooks.map(webhook => {
      return axios.post(webhook.url, payload, {
       ...
       headers: {
        Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiZjI3OTVhY2ItMzkzYy00ZjlkLTk3ZGItYzkzODI5NDUyZDEyIiwiZW1haWwiOiJhdGlzaGF5YUBlZHlzb3IuYWkiLCJyb2xlIjoiY29tcGFueSJ9LCJleHBpcmVzIjoxNzY0ODg2MDU0LCJpYXQiOjE3NjQ4NTAwNTR9.tnZ9BrbJOgi_djouDLZ_-0vNAdarGfoP_fmNjmair-M`,
